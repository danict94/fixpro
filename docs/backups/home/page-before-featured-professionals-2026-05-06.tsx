 ...
 *
 * Salvato in:
 * docs/backups/home/page-before-featured-professionals-2026-05-06.tsx
 *
 * Motivo:
 * Backup prima di rimuovere sezioni finte/deboli come recensioni e attività/richieste esempio,
 * e prima di valutare l'inserimento della sezione Professionisti in evidenza.
 */
              ...
              <div className="w-full lg:max-w-[540px]">
                ...
                <div className="mt-9 lg:w-[118%]">
                  ...
                  <div className="mt-3">
                    ...
                    >
                      Oppure esplora gli interventi piÃ¹ comuni
                    </Link>
                  </div>
                </div>
                ...
                <div className="mt-10 grid max-w-[510px] grid-cols-3 gap-8">
                  ...
                  <HeroFeature
                    ...
                    text="Meno attese, piÃ¹ soluzioni."
                    tone="amber"
                  />
                </div>
      ...
      >
        ...
        <div className="relative">
          <SectionIntro
            ...
            description="Descrivi il lavoro, ricevi risposte e scegli il professionista piÃ¹ adatto a te."
            align="center"
          />
        ...
        <div className="relative mt-14">
          ...
          <div className="relative grid gap-12 sm:grid-cols-3 lg:gap-8">
            ...
            <HowStep
              ...
              text="Confronta chiarezza, disponibilitÃ  e profili prima di decidere."
            />
          </div>
        </div>
  ...
  return (
    <SectionShell tone="muted" spacing="lg">
      <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
        <SectionIntro
          eyebrow="I lavori piÃ¹ richiesti"
          title="Parti dalle esigenze piÃ¹ comuni."
          description="Bagni, ristrutturazioni e impianti sono tra le richieste piÃ¹ frequenti. Puoi partire da qui o cercare il servizio piÃ¹ adatto alla tua situazione."
        />
        ...
        <div className="grid gap-10 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:gap-14">
          ...
          <div className="relative lg:pl-4">
            ...
            <h2 className="mt-3 max-w-[500px] text-[30px] font-semibold leading-[1.08] tracking-[-0.04em] text-secondary sm:text-[38px]">
              Vuoi ricevere richieste piÃ¹ adatte al tuo lavoro?
            </h2>
            ...
            >
              Scopri come funziona lâ€™area professionisti
              <ArrowRight className="h-4 w-4 transition group-hover:translate-x-0.5" />
            </Link>
          </div>
        </div>
          ...
          <div className="grid gap-0 lg:grid-cols-[0.82fr_1.18fr]">
            <div className="border-b border-border/70 px-6 py-7 sm:px-8 sm:py-9 lg:border-b-0 lg:border-r">
              ...
              <h3 className="mt-3 max-w-[420px] text-[26px] font-semibold leading-[1.12] tracking-[-0.035em] text-secondary sm:text-[32px]">
                Non sai quanto puÃ² costare il tuo lavoro?
              </h3>
            ...
            <div className="px-6 py-7 sm:px-8 sm:py-9">
              <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                <div>
                  <p className="text-[13px] font-semibold text-secondary">
                    Domande frequenti sui lavori piÃ¹ richiesti
                  </p>
              ...
              <div className="mt-5 rounded-[22px] border border-primary/15 bg-primary/5 px-4 py-4">
                ...
                <p className="mt-1 text-[13px] leading-6 text-muted-foreground">
                  ...
                  lavoro e ricevere preventivi piÃ¹ chiari.
                </p>
              </div>
            </div>
          </div>
